...
namespace Workflow
{
    public partial class HondaPOReview : Form
    {
        ...
        public HondaPOReview(string jobNo, bool readOnly, int workflow_id, bool newJob, JobListViewer jobViewer)
        {
            InitializeComponent();
            this.jobNo = jobNo;
        ...
        private void PopulateDataFromDB()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                if (reader.Read())
                {
                    ...
                    applicableCIDNosTextBox.Text = reader.IsDBNull(reader.GetOrdinal("Applicable_CID_Numbers")) ? "" : reader.GetString(reader.GetOrdinal("Applicable_CID_Numbers"));
        ...
        private void HondaPOReview_FormClosing(object sender, FormClosingEventArgs e)
        {
