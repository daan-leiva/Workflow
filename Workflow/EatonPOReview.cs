...
namespace Workflow
{
    public partial class EatonPOReview : Form
    {
        ...
        public EatonPOReview(string jobNo, bool readOnly, int workflow_id, bool newJob, JobListViewer jobViewer)
        {
            InitializeComponent();
            this.jobNo = jobNo;
        ...
        private void EatonPOReview_Load(object sender, EventArgs e)
        {
            // load label values
            if (!newJob)
            {
        ...
        private void PopulateDataFromDB()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    ...
                    ",[Drawing_Rev_5]\n" +
                    "FROM[ATI_Workflow].[dbo].[Eaton_PO_Review]\n" +
                ...
                if (reader.Read())
                {
                    ...
                    {
                        if (reader.GetString(reader.GetOrdinal("Question6_Response")).Equals("Yes"))
                        {
                            question6YesRadioButton.Checked = true;
                        }
                        else if (reader.GetString(reader.GetOrdinal("Question6_Response")).Equals("No"))
                        {
                            question6NoRadioButton.Checked = true;
                        }
                        else
                        {
                            question6NARadioButton.Checked = true;
                        }
                    }
                    ...
                    vqrTextBox.Text = reader.IsDBNull(reader.GetOrdinal("VQR")) ? "" : reader.GetString(reader.GetOrdinal("VQR"));
                    vqrDateTextBox.Text = reader.IsDBNull(reader.GetOrdinal("VQR_Date")) ? "" : reader.GetString(reader.GetOrdinal("VQR_Date"));
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            if (question3YesRadioButton.Checked || question4YesRadioButton.Checked
                ...
                || question6YesRadioButton.Checked)
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    "INSERT INTO [ATI_Workflow].[dbo].[Eaton_PO_Review]\n" +
                    "([Job]\n" +
                    ",[Workflow_ID]\n" +
                    ",[Status]\n" +
                    ",[AvailableOn]\n" +
                    ...
                    "," + (question6YesRadioButton.Checked ? "'Yes'" : (question6NoRadioButton.Checked ? "'No'" : (question6NARadioButton.Checked ? "'N/A'" : "NULL"))) + "\n" +
        ...
        private bool IsComplete()
        {
            ...
            valid =
                ...
                (question6YesRadioButton.Checked || question6NoRadioButton.Checked || question6NARadioButton.Checked) &&
        ...
        private void EatonPOReview_FormClosing(object sender, FormClosingEventArgs e)
        {
