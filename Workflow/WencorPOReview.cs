...
namespace Workflow
{
    public partial class WencorPOReview : Form
    {
        ...
        public WencorPOReview(string jobNo, bool readOnly, int workflow_id, bool newJob, JobListViewer jobViewer)
        {
            InitializeComponent();
            this.jobNo = jobNo;
            ...
            this.customer = "WENCOR";
        }

        private void WencorPOReview_Load(object sender, EventArgs e)
        {
            // load label values
            if (!newJob)
            {
        ...
        private void PopulateDataFromDB()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    ...
                    ",[Drawing_Rev_5]\n" +
                    "FROM[ATI_Workflow].[dbo].[Wencor_PO_Review]\n" +
                ...
                if (reader.Read())
                {
                    ...
                    {
                        if (reader.GetBoolean(reader.GetOrdinal("Question7_Response")))
                        {
                    ...
                    {
                        if (reader.GetString(reader.GetOrdinal("Question8_Response")).Equals("Yes"))
                        {
                            question8YesRadioButton.Checked = true;
                        }
                        else if (reader.GetString(reader.GetOrdinal("Question8_Response")).Equals("No"))
                        {
                            question8NoRadioButton.Checked = true;
                        }
                        else
                        {
                            question8NARadioButton.Checked = true;
                        }
                    }


                    if (!reader.IsDBNull(reader.GetOrdinal("Question9_Response")))
                    {
                        if (reader.GetBoolean(reader.GetOrdinal("Question9_Response")))
                        {
                            question9YesRadioButton.Checked = true;
                        }
                        else
                        {
                            question9NoRadioButton.Checked = true;
                        }
                    }

                    partNoLabel.Text = reader.IsDBNull(reader.GetOrdinal("Part_Number")) ? "" : reader.GetString(reader.GetOrdinal("Part_Number"));
                    partNoLabel.Enabled = false;
                    partNumberRevTextBox.Text = reader.IsDBNull(reader.GetOrdinal("Part_Number_Rev")) ? "" : reader.GetString(reader.GetOrdinal("Part_Number_Rev"));
                    ...
                    drawingNumberTextBox.Text = reader.IsDBNull(reader.GetOrdinal("Drawing_Number")) ? "" : reader.GetString(reader.GetOrdinal("Drawing_Number"));
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            if (question3YesRadioButton.Checked || question4YesRadioButton.Checked
                ...
                || question7YesRadioButton.Checked || question8YesRadioButton.Checked)
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    "INSERT INTO [ATI_Workflow].[dbo].[Wencor_PO_Review]\n" +
                    "([Job]\n" +
                    ",[Workflow_ID]\n" +
                    ",[Status]\n" +
                    ",[AvailableOn]\n" +
                    ...
                    "," + (question7YesRadioButton.Checked ? "1" : (question7NoRadioButton.Checked ? "0" : "NULL")) + "\n" +
                    "," + (question8YesRadioButton.Checked ? "'Yes'" : (question8NoRadioButton.Checked ? "'No'" : (question8NARadioButton.Checked ? "'N/A'" : "NULL"))) + "\n" +
                    "," + (question9YesRadioButton.Checked ? "1" : (question9NoRadioButton.Checked ? "0" : "NULL")) + "\n" +
                    ",'" + partNoLabel.Text.Trim() + "'\n" +
                    ",'" + partNumberRevTextBox.Text.Trim() + "'\n" +
        ...
        private bool IsComplete()
        {
            ...
            valid =
                ...
                (question7YesRadioButton.Checked || question7NoRadioButton.Checked) &&
                (question8YesRadioButton.Checked || question8NoRadioButton.Checked || question8NARadioButton.Checked);
        ...
        private void WencorPOReview_FormClosing(object sender, FormClosingEventArgs e)
        {
