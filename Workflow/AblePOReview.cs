...
namespace Workflow
{
    public partial class AblePOReview : Form
    {
        ...
        public AblePOReview(string jobNo, bool readOnly, int workflow_id, bool newJob, JobListViewer jobViewer)
        {
            InitializeComponent();
            this.jobNo = jobNo;
        ...
        private void AblePOReview_Load(object sender, EventArgs e)
        {
            // load label values
            if (!newJob)
            {
        ...
        private void PopulateDataFromDB()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    ...
                    ",[Drawing_Rev_5]\n" +
                    "FROM[ATI_Workflow].[dbo].[Able_PO_Review]\n" +
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(Globals.odbc_connection_string))
            {
                ...
                string query =
                    "INSERT INTO [ATI_Workflow].[dbo].[Able_PO_Review]\n" +
                    "([Job]\n" +
                    ",[Workflow_ID]\n" +
                    ",[Status]\n" +
                    ",[AvailableOn]\n" +
        ...
        private void AblePOReview_FormClosing(object sender, FormClosingEventArgs e)
        {
